...
**Current position: 4 minutes to midnight** (held through [Episode 24](/episodes/24-openais-goblin-problem-10-lessons-when-code-is-cheap-ai-addiction-loop/), mid-May 2026)
...
A chronological record of the events we've tracked across 24 episodes, with links to every source we discussed.
...
### Phase 6: The Snapback Holds (Apr-May 2026, Episodes 22-24)

*The Mythos-driven swing extended through three more episodes on different lines of argument: historical-comparison (ep 22), geopolitical-stakes (ep 23), and a hold (ep 24) as bullish funding-flood signals offset OpenAI's subscription-collapse projection. The clock moved 2:45 → 3:30 → 4:00 and held — the most optimistic stretch in the show's run.*
